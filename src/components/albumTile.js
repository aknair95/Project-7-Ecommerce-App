                ...
                <Row>
                    <Col className="mt-4" xs={4}>
                        <Card className="shadow-lg">
                            ...
                            <Button value={props.albumDetails1.title} onClick={onClickAddtoCart} style={{fontWeight:"bold",float:"right"}}>
                                ADD TO CART
                            </Button>
                        </Card>
                    </Col>
                    <Col className="mt-4" xs={4} style={{marginLeft:"26rem"}}>
                        <Card className="shadow-lg">
                            ...
                            <Button value={props.albumDetails2.title} onClick={onClickAddtoCart} style={{fontWeight:"bold",float:"right" }}>
                                ADD TO CART
                            </Button>
                        </Card>
                    </Col>
